...
class LiveLabel: UILabel {
    ...
    func updateText() {
        ...
        var fromNowCapitalize = fromNowLowercase
        fromNowCapitalize.replaceRange(fromNowLowercase.startIndex...fromNowCapitalize.startIndex, with: String(fromNowCapitalize[fromNowCapitalize.startIndex]).uppercaseString)
